...
### D-135: Pool do `pg` com listener de `error`, timeouts de sessão e timeout de `fetch` para os gateways (CRMLAB-30)
...
### D-136: `unhandledRejection`/`uncaughtException` derrubam o processo pelo MESMO shutdown do SIGTERM (CRMLAB-30)
