...
**Última atualização:** 2026-09-06 (Onda 8 §3 entregue: respostas rápidas — tela própria e `/` no Composer)
...
| §4 Onda 3 — mídia (anexo e áudio) | — | ⬜ | — | Depende de armazenamento, que não existe no projeto hoje. Não iniciar antes de validar e commitar a Onda 2 (decisão do lead) |
